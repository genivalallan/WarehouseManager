...
> [!TIP]
> You can find more information at [Microsoft Docs](https://docs.microsoft.com/en-us/dotnet/core/install/linux) about installation on other linux distributions.
...
> [!TIP]
> See [Docs Docker](https://docs.docker.com/) for more information about Docker and installation.  
...
> [!IMPORTANT]
> I'm using .NET Secret Manager tool to store connection string data. You should change the code to use your own connection string.  
...
#### 3.4.1 Using .NET Secret Manager tool

Use the .NET Core CLI to initialize your secret storage and configure the project.  
...
To build and run using the **terminal**, use the following commands:
